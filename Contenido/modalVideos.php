...
<div class="ui basic modal" id="modalComoCrearUnNuevoCurso">
  ...
  <div class="ui basic modal" id="modalComoGestionarDocentes">
    <div class="ui icon header">
    ...
    <div class="ui basic modal" id="modalComoCrearUnaNuevaAula">
      <div class="ui icon header">
      ...
      <div class="ui basic modal" id="modalComoSubirUnNuevoRecurso">
        <div class="ui icon header">
        ...
        <div class="ui basic modal" id="modalComoIniciarSesionComoEstudiante">
          <div class="ui icon header">
          ...
          <div class="ui basic modal" id="modalComoRegistrarmeComoDocente">
            <div class="ui icon header">
            ...
            <div class="ui basic modal" id="modalComoRegistrarmeComoInstituto">
              <div class="ui icon header">
