	...
	<div class="col-md-12">	<br>
		...
		<div class="row mb-4" >
			...
			<div class="col-lg-6">
				...
				<input type="email" name="txtAsignatura" id="txtAsignatura" value="<?php echo $dataW['Asignatura']; ?>" class="form-control">
			</div>
		...
		<div class="row mb-4" >
			...
			<div class="col-lg-6">
				...
				<div class="ui fluid selection dropdown" id="ddDocente">
					...
					<div class="menu">
						<?php
						$consulta = sprintf("SELECT CONCAT(tblUsuario.Nombre, ' ', tblUsuario.Apellido) AS Nombre, tblUsuario.IDUsuario From tblUsuario, tbldocxinstituto WHERE tbldocxinstituto.IDDocente = tblUsuario.IDUsuario and tbldocxinstituto.IDInstituto = '%s' AND tblusuario.TipoUsuario != 2",
							$conexion->antiInyeccion($_SESSION["Instituto"]));
						$resultado = $conexion->ejecutarconsulta($consulta);
						$iter = $conexion->cantidadRegistros($resultado);
						for ($i=0; $i < $iter; $i++) {
		...
		<div class="row mb-3 ml-2">
			...
			<div class="col-lg-4">
				<button class="ui fluid blue button" onclick="actualizarAula()">Aceptar</button>
			</div>
		</div>
		<div class="row mb-3 ml-2">
			<div class="col-lg-4"></div>
			<div class="col-lg-4">
				<a href="#" class="ui fluid red button" onclick="cargarDiv('columnaContenido', 'Contenido/moduloAulas.php')">Cancelar</a>
			</div>
		</div>
		<div class="col-lg-4"></div>
	</div>
